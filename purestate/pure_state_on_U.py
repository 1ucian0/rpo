    ...
    def run(self, dag):
        ...
        for node in dag.topological_op_nodes():
            ...
            if isinstance(node.op, ControlledGate):
                ...
                self.wire_state.u3(node.qargs[0], [node.op.params[0], node.op.params[1], node.op.params[2]])
                print(self.wire_state[node.qargs[0]], node.op.params[0], node.op.params[1], node.op.params[2])
